...
// Credentials
$dbhost = "localhost";
$dbname = "j3919707_shop";
$dbuser = "j3919707_jonshop";
$dbpass = "JAN27jan";
...
if (strlen($search_string) >= 1 && $search_string !== ' ') {
	...
	if (isset($result_array)) {
		foreach ($result_array as $result) {
			...
			$display_function = preg_replace("/".$search_string."/i", "".$search_string."", $result['function']);
			
			
			$display_name = preg_replace("/".$search_string."/i", "<b class='highlight' style='color:#406dff;'>".$search_string."</b>", $result['name']);

			$display_url = 'http://www.schoolitup.com/shop/locations/'.urlencode($result['function']).'';
		...
		$output = str_replace('nameString', 'No Cities Found.', $output);
